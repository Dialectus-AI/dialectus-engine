...
class PublicForumFormat(DebateFormat):
    """Public Forum Debate format for discussing current events and real-world issues."""
    ...
    def get_format_instructions(self) -> str:
        ...
        return """PUBLIC FORUM DEBATE FORMAT:
            ...
            - Use concrete evidence from credible sources (news, studies, expert opinions)
