...
@app.post("/api/tournaments/{tournament_id}/advance")
...
@app.get("/api/tournaments/{tournament_id}/rounds/{round_number}/status")
...
# Initialize auth database manager - ensure database is created with schema
...
@app.post("/api/auth/complete-registration", response_model=MessageResponse,
