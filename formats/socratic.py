...
class SocraticFormat(DebateFormat):
    ...
    def get_phases(self, participants: list[str]) -> list[FormatPhase]:
        ...
        return [
            ...
            FormatPhase(
                ...
                instruction="Engage in the first round of Socratic inquiry. Questioner: probe assumptions and explore implications. Responder: answer thoughtfully and honestly.",
            ...
            FormatPhase(
                ...
                instruction="Continue deeper exploration. Questioner: build on previous answers to reveal contradictions or new insights. Responder: examine your own thinking carefully.",
                speaking_order=[questioner, responder, questioner, responder],
                time_multiplier=0.9,
            ),
            FormatPhase(
                ...
                name="Role Reversal",
                instruction="Now the responder questions the questioner's approach or assumptions. Explore what the questioning itself has revealed.",
            ...
            FormatPhase(
                ...
                instruction="Reflect together on what has been discovered through this dialogue. What new understanding or questions have emerged? What remains to be explored?",
                speaking_order=[responder, questioner],
                time_multiplier=1.2,
            ),
        ]
    ...
    def get_topic_generation_messages(
        ...
        socratic_system = "You are an expert at generating Socratic dialogue topics. Socratic dialogues explore fundamental questions about knowledge, ethics, truth, and human nature through inquiry and questioning."
        ...
        socratic_user = f"Generate a single topic suitable for Socratic dialogue that explores fundamental philosophical questions. The topic should invite deep inquiry about concepts like truth, justice, knowledge, virtue, or human nature.{theme_tone_requirements} Make it thought-provoking for philosophical exploration. Respond with just the topic statement, no additional text or explanation."
